...
class _VcState extends State<Vc> {
  ...
  Future<void> initAgora() async {
    ...
    await _engine.joinChannel(
      token: "007 eJxTYDB+eIHp1RKe1Nxj0a/uHFv1I/1S0zM/vTiztnUrP33yiIpRYDBNTTEzTTU0MTM3TjVJNklJMjBIMjAzSkoyNU02MDU09+bhS28IZGRYFSLHysgAgSA+O0NaTmlJSWoRAwMASg0hdQ==",
      channelId: "flutter",
      uid: 0,
...
//
//
//   Future<void> sendCallNotification(String token, String caller) async {
//     await http.post(
...
//         _showCallUI(message.data['caller']);
//       }
//     });
//   }
//
//   void _showCallUI(String caller) {
//     showDialog(
//       context: context,
//       builder: (context) {
//         return AlertDialog(
...
//
//   void _acceptCall() {
//     // Call logic to connect to Agora channel
//     Navigator.push(
//       context,
//       MaterialPageRoute(
//         builder: (context) => Vc(selectedUsername: 'callerName'),
//       ),
//     );
//   }
//
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Video Call with ${widget.selectedUsername}'),
//       ),
//       body: Stack(
//         children: [
...
//                   IconButton(
//                     icon: Icon(
//                       _cameraOff ? Icons.camera_alt : Icons.camera_alt_outlined,
//                       color: _cameraOff ? Colors.red : Colors.black,
//                     ),
//                     onPressed: _onToggleCamera,
//                   ),
...
//       );
//     } else {
//       return const Text('Please wait for remote user to join', textAlign: TextAlign.center);
//     }
//   }
// }
